...
//using namespace std;
//
//bool DoTree1HaveTree2(BinaryTreeNode* pRoot1,BinaryTreeNode* pRoot2)
//{
//	if(NULL == pRoot2)
//		return true;
//	if(NULL == pRoot1)
...
//		return false;
//
//	return DoTree1HaveTree2(pRoot1->m_pLeft,pRoot2->m_pLeft) &&
//		DoTree1HaveTree2(pRoot1->m_pRight,pRoot2->m_pRight);
//}
//
//bool HaveSubTree(BinaryTreeNode* pRoot1,BinaryTreeNode* pRoot2)
//{
...
//
//	if(pRoot1->m_nValue == pRoot2->m_nValue)
//		bResult = DoTree1HaveTree2(pRoot1,pRoot2);
//	if(!bResult)
//		bResult = HaveSubTree(pRoot1->m_pLeft,pRoot2);
//	if(!bResult)
//		bResult = HaveSubTree(pRoot1->m_pRight,pRoot2);
//	return bResult;
//}
//// ====================测试代码====================
//void Test(char* testName, BinaryTreeNode* pRoot1, BinaryTreeNode* pRoot2, bool expected)
//{
//    if(HaveSubTree(pRoot1, pRoot2) == expected)
//        printf("%s passed.\n", testName);
//    else
//        printf("%s failed.\n", testName);
//}
